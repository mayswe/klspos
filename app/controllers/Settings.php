...
class Settings extends MY_Controller
{
    ...
    public function get_stores()
    {
        ...
        ->unset_column('id');
        // <a href='" . site_url('settings/delete_store/$1') . "' onClick=\"return confirm('". $this->lang->line('alert_x_store') ."')\" class='tip btn btn-danger btn-xs' title='".$this->lang->line("delete_store")."'><i class='fa-solid fa-trash'></i></a>
        echo $this->datatables->generate();
    }
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == true) {
            $data = [
                ...
                'default_email'     => DEMO ? 'swe.mayhtike@gmail.com' : $this->input->post('default_email'),
