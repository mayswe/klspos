    ...
    "<div class='text-center'>
        <div class='btn-group'>
            ...
            <ul class='dropdown-menu dropdown-menu-right'>
                <li>
                    <a href='" . site_url('gift_cards/view/$1') . "' class='tip' title='" . lang('view_gift_card') . "' data-toggle='ajax-modal'>
                        <i class='fa fa-eye'></i> " . lang('view_gift_card') . "
                    </a>
                </li>
                <li>
                    <a href='" . site_url('gift_cards/edit/$1') . "' class='tip' title='" . lang('edit') . "'>
                        <i class='fa fa-edit'></i> " . lang('edit') . "
                    </a>
                </li>
                <li>
                    <a href='" . site_url('gift_cards/delete/$1') . "' class='tip text-danger' title='" . lang('delete') . "' onClick=\"return confirm('" . lang('alert_x_gift_card') . "')\">
