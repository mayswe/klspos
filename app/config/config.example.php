...
$config['base_url'] = 'http://localhost/klspos/';
...
|
*/
$config['encryption_key'] = 'REPLACE_WITH_A_RANDOM_LOCAL_KEY';
...
$config['sess_save_path'] = sys_get_temp_dir(); // Or writable path like APPPATH . 'cache/sessions'
...
$config['csrf_exclude_uris'] = array('api/auth/google', 'api/.*');
/*
|--------------------------------------------------------------------------
| Output Compression
|--------------------------------------------------------------------------
