...
<?php
/*
 * KLSPOS Customers List mobile/app mode.
 */
$is_app_mode =
    !empty($is_app_mode) ||
...
$add_customer_url =
    site_url('customers/add') . $app_query;
?>
...
<style>
/* =========================================================
   KLSPOS Customers List - True Mobile/App Layout
...
/* Prevent Bootstrap row-like pseudo layout issues */
...
/* Keep customer table usable with horizontal swipe */
    ...
    $(document).ready(function() {
        ...
        function updateSummaryCards(api) {
            ...
            api.rows({ search: 'applied' }).every(function() {
                ...
                if (row.group_name && $.trim(row.group_name) !== '') {
                    groups[$.trim(row.group_name)] = true;
                }
            });

            $('#customer_records').html(records);
            $('#customer_phone').html(withPhone);
            $('#customer_email').html(withEmail);
            $('#customer_groups').html(Object.keys(groups).length);
        }
            ...
            columns: [
                { data: 'id', visible: false },
                {
                    ...
                    render: function(data, type, row) {
                        if (type === 'display') {
                            return '<span class="customer-link">' + cleanText(data) + '</span>';
                        }
                        return data || '';
                    }
                },
                ...
                { data: 'group_name', render: cleanText },
                {
                    data: 'Actions',
                    searchable: false,
                    orderable: false,
        ...
        <div class="col-xs-12">
            <div class="box box-primary" style="border-radius:10px; border-top:0; overflow:hidden;">
                <div class="erp-header">
                    ...
                    <a
                        href="<?= html_escape($add_customer_url); ?>"
                        class="btn btn-primary"
                    >
                        <i class="fa fa-plus"></i> <?= lang('add_customer'); ?>
                    </a>
                </div>
                        ...
                        <div class="col-md-3 col-sm-6 erp-stat-item">
                            <div class="erp-summary-card erp-stat-card">
                                <div>
                                    ...
                                    <div class="erp-stat-value" id="customer_records">0</div>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-6 erp-stat-item">
                            <div class="erp-summary-card erp-stat-card">
                                <div>
                                    ...
                                    <div class="erp-stat-value" id="customer_phone">0</div>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-6 erp-stat-item">
                            <div class="erp-summary-card erp-stat-card">
                                <div>
                                    ...
                                    <div class="erp-stat-value" id="customer_email">0</div>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-6 erp-stat-item">
                            <div class="erp-summary-card erp-stat-card">
                                <div>
                                    ...
                                    <div class="erp-stat-value" id="customer_groups">0</div>
                                </div>
                                <div class="erp-stat-icon"><i class="fa fa-object-group"></i></div>
                            </div>
                        </div>
                    </div>
