    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <table width="100%" class="stable">
                <tr>
                    <td style="border-bottom: 1px solid #0C7785;"><h4><?= lang('cash_sale'); ?>:</h4></td>
                    <td style="text-align:right; border-bottom: 1px solid #0C7785;"><h4>
                ...
                <tr>
                    <td style="border-bottom: 1px solid #0C7785;"><h4><?= lang('gc_sale'); ?>:</h4></td>
                    <td style="text-align:right;border-bottom: 1px solid #0C7785;"><h4>
                ...
                <?php if (isset($Settings->stripe)) { ?>
                    <tr>
                        <td style="border-bottom: 1px solid #0C7785;"><h4><?= lang('stripe'); ?>:</h4></td>
                        <td style="text-align:right;border-bottom: 1px solid #0C7785;"><h4>
                ...
                <tr>
                    <td style="border-bottom: 1px solid #0C7785;"><h4><?= lang('other_sale'); ?>:</h4></td>
                    <td style="text-align:right;border-bottom: 1px solid #0C7785;"><h4>
