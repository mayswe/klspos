...
<div class="col-md-6">
    ...
    <div class="form-group form-group-lg">
        ...
        <input name="quantity" type="number" step="0.01" id="quantity" value="<?= set_value('quantity'); ?>" class="form-control" required />
    </div>
    ...
    <div class="form-group form-group-lg">
        <?= lang("total", "total"); ?>
        <input name="total" type="number" step="0.01" id="total" value="<?= set_value('total'); ?>" class="form-control" required />
    </div>
