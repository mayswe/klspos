...
/* Action icon meanings shown below the product table */
.erp-action-legend {
    margin-top: 16px;
    padding: 16px;
...
.erp-action-legend-view .erp-action-legend-icon {
    border-color: #cfe0ff;
    background: #e6efff;
    color: #2563eb;
}

.erp-action-legend-unit .erp-action-legend-icon,
.erp-action-legend-stock .erp-action-legend-icon {
    border-color: #bce8cc;
    background: #dff7e7;
    color: #15803d;
}

.erp-action-legend-print .erp-action-legend-icon,
.erp-action-legend-copy .erp-action-legend-icon {
    border-color: #f0e2bd;
    background: #fbf1d8;
    color: #8a6411;
}

.erp-action-legend-delete .erp-action-legend-icon {
    border-color: #ffc3cb;
    background: #ffe2e6;
    color: #dc3545;
}
...
<div class="product-search-help">
    ...
    <div>
        ...
        <span>
            ရှာဖွေလိုသော ကုန်ပစ္စည်း၏ ကုဒ်၊ အမည်၊ ယူနစ်၊ အရေအတွက်တို့ ရိုက်ထည့်ပြီး ရှာဖွေနိုင်ပါသည်။ 
        </span>
    </div>
</div>
                ...
                <div class="erp-column-filters" id="product-column-filters">
                    ...
                    <div class="erp-column-filter">
                        ...
                        <input type="text" class="erp-and-filter-input" data-column="5" placeholder="<?= html_escape($base_quantity_label); ?>">
                    </div>
                    <div class="erp-column-filter">
                        <i class="fa fa-balance-scale"></i>
                        <input type="text" class="erp-and-filter-input" data-column="6" placeholder="<?= html_escape($base_unit_label); ?>">
                    </div>
                </div>
