                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group form-group-lg">
                                    <?= lang('unit', 'unit'); ?>
                                    <?php
                                    $cat[''] = lang("select") . " " . lang("unit");
                                    foreach ($units as $unit) {
                                        $cat[$unit->id] = $unit->name;
                                    }
                                    ?>
                                    <?= form_dropdown('unit', $cat, set_value('unit'), 'class="form-control select2 tip" id="unit"  required="required" style="width:100%;"'); ?>
                                </div>
...
<script>
    $(document).on('click', '.add-row', function() {
        var row = '<tr>' +
            ...
            '<td><input type="number" step="0.0001" name="operation_value[]" class="form-control"></td>' +
