...
<?php
/*
 * KLSPOS Suppliers List mobile/app mode.
 */
$is_app_mode =
    !empty($is_app_mode) ||
...
$add_supplier_url =
    site_url('suppliers/add') . $app_query;
?>
...
<style>
/* =========================================================
   KLSPOS Suppliers List - True Mobile/App Layout
...
/* Hide desktop export and page-length controls in app mode */
.erp-page .erp-dt-top,
.erp-page .dt-buttons,
.erp-page .dataTables_length {
    display: none !important;
...
/* Keep supplier table usable with horizontal swipe */
...
.erp-page #CuData thead th,
.erp-page #CuData tbody td,
.erp-page #CuData tfoot th {
    ...
    $(document).ready(function() {
        ...
        function updateSummaryCards(api) {
            ...
            api.rows({ search: 'applied' }).every(function() {
                ...
                if (row.cf1 && $.trim(row.cf1) !== '') {
                    withCf1++;
                }
            });

            $('#supplier_records').html(records);
            $('#supplier_phone').html(withPhone);
            $('#supplier_email').html(withEmail);
            $('#supplier_cf1').html(withCf1);
        }
        ...
        var table = $('#CuData').DataTable({
            ...
            autoWidth: false,
            buttons: [
                { extend: 'copyHtml5', footer: false, exportOptions: { columns: [1, 2, 3, 4, 5] } },
                { extend: 'excelHtml5', footer: false, exportOptions: { columns: [1, 2, 3, 4, 5] } },
                { extend: 'csvHtml5', footer: false, exportOptions: { columns: [1, 2, 3, 4, 5] } },
                { extend: 'pdfHtml5', orientation: 'landscape', pageSize: 'A4', footer: false, exportOptions: { columns: [1, 2, 3, 4, 5] } },
            ...
            columns: [
                { data: 'id', visible: false },
                {
                    ...
                    render: function(data, type, row) {
                        if (type === 'display') {
                            return '<span class="supplier-link">' + cleanText(data) + '</span>';
                        }
                        return data || '';
                    }
                },
                ...
                { data: 'cf1', render: cleanText },
                { data: 'cf2', render: cleanText },
                {
                    data: 'Actions',
                    searchable: false,
                    orderable: false,
            ...
            <div class="box box-primary" style="border-radius:10px; border-top:0; overflow:hidden;">
                <div class="erp-header">
                    <div class="erp-title-wrap">
                        <div class="erp-title-icon"><i class="fa fa-truck"></i></div>
                        <div>
                    ...
                    <a
                        href="<?= html_escape($add_supplier_url); ?>"
                        class="btn btn-primary"
                    >
                        <i class="fa fa-plus"></i> <?= lang('add_supplier'); ?>
                    </a>
                </div>
                ...
                <div class="erp-body">
                    <div class="erp-stat-grid">
                        <div class="col-md-3 col-sm-6 erp-stat-item">
                            <div class="erp-summary-card erp-stat-card">
                                <div>
                                    ...
                                    <div class="erp-stat-value" id="supplier_records">0</div>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-6 erp-stat-item">
                            <div class="erp-summary-card erp-stat-card">
                                <div>
                                    ...
                                    <div class="erp-stat-value" id="supplier_phone">0</div>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-6 erp-stat-item">
                            <div class="erp-summary-card erp-stat-card">
                                <div>
                                    <div class="erp-stat-label"><?= lang('email_address'); ?></div>
                                    <div class="erp-stat-value" id="supplier_email">0</div>
                                </div>
                                <div class="erp-stat-icon"><i class="fa fa-envelope"></i></div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 erp-stat-item">
                            <div class="erp-summary-card erp-stat-card">
                                <div>
                                    <div class="erp-stat-label"><?= lang('ccf1'); ?></div>
                                    <div class="erp-stat-value" id="supplier_cf1">0</div>
                                </div>
                                <div class="erp-stat-icon"><i class="fa fa-info-circle"></i></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="erp-table-card">
                        ...
                        <div class="table-responsive">
                            <table id="CuData" class="table table-bordered table-hover table-striped" style="width:100%; margin-bottom:5px;">
                                <thead>
                                    <tr>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th><input type="text" class="text_filter" placeholder="[<?= lang('email_address'); ?>]"></th>
                                        <th><input type="text" class="text_filter" placeholder="[<?= lang('ccf1'); ?>]"></th>
                                        <th><input type="text" class="text_filter" placeholder="[<?= lang('ccf2'); ?>]"></th>
