...
<section class="content">
                ...
                <div class="box-body">
                    <div id="form" class="panel panel-warning">
                        <div class="panel-body">
                            <?= form_open("reports/purchasesupplier");?>
    ...
    <?php if ($this->input->post('supplier') && ($total_sales->amount - $total_sales->paid) > 0) { ?>
    <div class="row">
        <div class="col-md-3" style="margin-top:15px">
            <a href="<?= site_url('reports/supplierdueprintall/' . $this->input->post('supplier') . '/1'); ?>" 
