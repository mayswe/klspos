...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = $('#ProductSalesData').DataTable({
            dom: 'Bfrtip',
            'ajax' : { url: '<?=site_url('reports/get_product_purchase/'. $v);?>', type: 'POST', "data": function ( d ) {
    ...
    // Footer display
    $(api.column(3).footer()).html(formatQty(totalPrimaryQty, 'display'));

    $(api.column(4).footer()).html(formatQty(totalSecondaryQty, 'display'));
                ...
                <div class="box-body">
                    <div id="form" class="panel panel-warning">
                        <div class="panel-body">
                            <?= form_open("reports/dailyspurchases");?>
